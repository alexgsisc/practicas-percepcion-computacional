# Se utiliza OpenCV para segmentar y clasificar dos manzanas dentro de una imagen, el primer método utilizado fue la detección 
...
# 2. Fase de Preprocesamiento: gris + blur
gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
blur = cv2.GaussianBlur(gray, (7, 7), 0)


# 3. Empieza a segmentar usando Canny 
...
# 4. Empiza a buscar los contornos de forma automatica
...
# 6. Dibuja las clasificaciones sobre la imagen original
...
# 8. Mostrar imagenes con Matplotlib
