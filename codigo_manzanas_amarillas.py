...
# ====================================
# 1. RUTAS EN WINDOWS (MODIFICAR SI ES NECESARIO)
# ====================================
...
# ====================================
img = cv2.imread(ruta_imagen)  # Lee la imagen desde disco
...
# ====================================
# 3. Convertir a HSV y detectar color amarillo
# ====================================
hsv = cv2.cvtColor(img, cv2.COLOR_BGR2HSV)  # Convierte la imagen de BGR (formato OpenCV) a HSV
...
# Crear máscara binaria: los píxeles dentro del rango serán blancos (255), los demás negros (0)
mask = cv2.inRange(hsv, lower_yellow, upper_yellow)
 
# ====================================
# 4. Limpieza de la máscara con morfología
# ====================================
...
resaltada[mask_clean == 255] = np.clip(
    resaltada[mask_clean == 255] * 1.4,     # Multiplica el brillo del área detectada
...
# OpenCV usa BGR, Matplotlib usa RGB → Convertimos
